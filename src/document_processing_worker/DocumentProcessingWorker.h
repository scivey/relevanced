...
class DocumentProcessingWorkerIf {
 public:
  virtual folly::Future<std::shared_ptr<models::ProcessedDocument>> processNew(
      std::shared_ptr<models::Document>) = 0;
...
class DocumentProcessingWorker : public DocumentProcessingWorkerIf {
 ...
 public:
  DocumentProcessingWorker(
      ...
      std::shared_ptr<wangle::FutureExecutor<wangle::CPUThreadPoolExecutor>>
          threadPool);
  folly::Future<std::shared_ptr<models::ProcessedDocument>> processNew(
      std::shared_ptr<models::Document>) override;
