...
public:
  ...
  virtual std::vector<std::string> listDocumentRangeFromId(const std::string &id, size_t count) = 0;
  virtual std::vector<std::string> listDocumentRangeFromOffset(size_t offset, size_t count) = 0;
  ...
  virtual std::vector<std::string> listCentroidRangeFromOffset(size_t offset, size_t limit) = 0;
  virtual std::vector<std::string> listCentroidRangeFromId(const std::string& startingCentroidId, size_t limit) = 0;
  ...
  virtual folly::Try<std::vector<std::string>> listCentroidDocumentRangeFromOffset(const std::string&, size_t offset, size_t limit) = 0;
  virtual folly::Optional<std::vector<std::string>> listCentroidDocumentRangeFromOffsetOption(const std::string&, size_t offset, size_t limit) = 0;

  virtual folly::Try<std::vector<std::string>> listCentroidDocumentRangeFromDocumentId(const std::string&, const std::string&, size_t limit) = 0;
  virtual folly::Optional<std::vector<std::string>> listCentroidDocumentRangeFromDocumentIdOption(const std::string&, const std::string&, size_t limit) = 0;

  virtual folly::Optional<std::string> getCentroidMetadata(const std::string&, const std::string&) = 0;
  virtual folly::Try<bool> setCentroidMetadata(const std::string&, const std::string&, std::string) = 0;
...
class SyncPersistence: public SyncPersistenceIf {
  ...
  std::vector<std::string> listCentroidDocumentRangeFromOffsetRaw(const std::string&, size_t, size_t);
  std::vector<std::string> listCentroidDocumentRangeFromDocumentIdRaw(const std::string&, const std::string&, size_t);
...
public:
  ...
  std::vector<std::string> listDocumentRangeFromId(const std::string &id, size_t count) override;
  std::vector<std::string> listDocumentRangeFromOffset(size_t offset, size_t count) override;
  ...
  std::vector<std::string> listCentroidRangeFromOffset(size_t offset, size_t limit) override;
  std::vector<std::string> listCentroidRangeFromId(const std::string& startingCentroidId, size_t limit) override;
  ...
  folly::Optional<std::string> getCentroidMetadata(const std::string&, const std::string&) override;
  folly::Try<bool> setCentroidMetadata(const std::string&, const std::string&, std::string) override;
